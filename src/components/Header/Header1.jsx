...
const Header1 = ({ className = '' }) => {
    ...
    return (
        <header className={`flex w-full backdrop-blur-2xl bg-neutral-950 text-white ${className}`}>

            <Container >
                <nav className="grid grid-cols-1 py-2 w-full ">
                                ...
                                item.active ? (
                                    <li key={item.name}>
                                        <button
                                            ...
                                            className='flex px-7 py-2 backdrop-blur-sm bg-[rgba(246,244,244,0.1)] rounded-md'
                                        >
                                            {item.name}
                                        </button>
                                    </li>
